...
with tabs[1]:
    ...
    # --- الإضافة الجديدة: مقارنة الموديلات والقصة التحليلية مع الـ Precision ---
    with st.expander("⚙️ Offline Model Selection & Evaluation Metrics"):
        ...
        # جدول المقارنة بالأرقام الحقيقية المحدثة مع إضافة الـ Precision
        ...
        # تلوين صف XGBoost لتمييزه كـ Champion Model
